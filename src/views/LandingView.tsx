        ...
        <div>
            <LandingBlock>
                ...
                <div style={{ textAlign: 'center', display: 'block', margin: '3rem' }}>
                    <img src="/assignment-3-kategorbunova/Image1.jpg" alt="dumbbells floating" width="80%" />
                </div>
            </LandingBlock>

            <LandingBlock>
                <div style={{ textAlign: 'center', display: 'block', margin: '3rem' }}>
                    <img src="/assignment-3-kategorbunova/Image2.jpg" alt="dumbbells floating" width="80%" />
                </div>
